...
public class Routes {
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute(){
        return GatewayRouterFunctions.route("inventory_order_swagger")
                .route(RequestPredicates.path("aggregate/order-service/v3/api-docs"), HandlerFunctions.http(inventoryServiceUrl))
